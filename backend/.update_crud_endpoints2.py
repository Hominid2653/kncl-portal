...
endpoint_data = [
    ...
    {
        'filename': 'user_profiles.py',
        'schema_module': 'user_profile',
        'model': 'UserProfile',
        'tag': 'User Profiles',
    ...
    {
        'filename': 'club_members.py',
        'schema_module': 'club_member',
        'model': 'ClubMember',
        'tag': 'Club Members',
    ...
    {
        'filename': 'registrations.py',
        'schema_module': 'registration',
        'model': 'Registration',
        'tag': 'Registrations',
    ...
    {
        'filename': 'transfer_approvals.py',
...
for config in endpoint_data:
    ...
    if config['update_schema']:
        imports.append(config['update_schema'])
    schema_imports = ',\n    '.join(imports)
    ...
    Path('app/api/v1/endpoints').joinpath(config['filename']).write_text(content)

print('updated base classes and endpoints')
