...
import PresentationPage from "@/pages/ppt/PresentationPage";
...
const router = createBrowserRouter([
  ...
  { path: "/ppt", element: <PresentationPage /> },
...

  {
    element: (
      <ProtectedRoute
        allowedRoles={["LEAGUE_COORDINATOR", "FEDERATION_ADMIN"]}
      />
    ),
    children: [
      { path: "/admin", element: <AdminDashboardPage /> },
      {
        ...
        element: <AdminClubApplicationsPage />,
      },
      {
        path: "/admin/player-applications",
        element: <AdminPlayerApplicationsPage />,
      },
      {
        path: "/admin/headshot-moderation",
        element: <AdminHeadshotModerationPage />,
      },
